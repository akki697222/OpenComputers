...
object Blocks {
  ...
  def init(bus: IEventBus): Unit = {
    ...
    BLOCKS.register(Constants.BlockName.CaseTier4,         () => Items.registerBlock(new Case(defaultProps, Tier.Four), Constants.BlockName.CaseTier4, defaultItemProps.rarity(OCRarity.LEGENDARY.getValue)))
    ...
    BLOCKS.register(Constants.BlockName.ScreenTier4,       () => Items.registerBlock(new Screen(defaultProps, Tier.Four), Constants.BlockName.ScreenTier4, defaultItemProps.rarity(OCRarity.LEGENDARY.getValue)))
