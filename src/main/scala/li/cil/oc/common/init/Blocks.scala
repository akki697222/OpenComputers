...
object Blocks {
  ...
  def init(bus: IEventBus): Unit = {
    ...
    BLOCKS.register(Constants.BlockName.Assembler,         () => Items.registerBlock(new Assembler(defaultProps.noOcclusion()), Constants.BlockName.Assembler, defaultItemProps))
