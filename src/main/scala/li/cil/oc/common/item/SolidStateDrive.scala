...
class SolidStateDrive(props: Properties, val tier: Int) extends Item(props) with traits.SimpleItem with traits.ItemTier with traits.FileSystemLike with IItemExtension {
  @Deprecated
